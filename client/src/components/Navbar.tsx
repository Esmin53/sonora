    ...
    return (
        <div className='dark:bg-foreground-dark bg-foreground-light w-full flex items-center justify-center z-10'>
            <div className=' w-full h-12 flex p-2 items-center justify-between max-w-7xl'>
                <a href='/' className='text-4xl font-bold dark:text-accent-dark text-accent-light'>Sonora</a>
                <div className={ `dark:bg-background-dark bg-background-light w-16 py-0.5 rounded-full shadow flex items-center px-2 cursor-pointer border dark:border-accent-dark border-accent-light ${theme === "dark" ? "justify-end" : "justify-start"} z-20` } onClick={() => setTheme(theme == "dark" ? "" : "dark" )}
                    >
